...
export default function ChatWithInvestor() {
  ...
  const [userId, setuserId] = useState(
    myData === "investor" ? item.investorId : item.startupId
  );
  ...
  const [receiverId, setReceiverId] = useState(
    myData === "investor" ? item.startupId : item.investorId
  );
        ...
        <section className="mt-sm-5 mt-2 pt-4 ">
          <div className="container">
                  ...
                  <>
                    <div className="d-flex align-items-end ms-sm-5 ms-2">
                      ...
                      >
                        <h4 className="h4">Profile</h4>
                        <p className="lead ">
                          {inquiry.investorData.InvestorName}
                        </p>
                      </div>
                    </div>
                  </>
            ...
            {messageComponent && (
              ...
              >
                <div className="space d-flex align-item-center- justify-content-end backk">
                  <div className="chatboxx backk">
                    <span></span>
                  </div>
                  <div className="accordian backk">
                    <div
                      className="chatpop backk"
                      style={{ width: "400px", height: "auto" }}
                    >
                      <Accordion defaultActiveKey="0">
                        <Accordion.Item eventKey="0">
                          <Accordion.Header
                            className="flex justify-center items-center backk "
                            onClick={() => setMessageComponent(false)}
                          >
                            <div className="profile flex justify-center items-center font-[500] h-[100%] w-[100%]">
                              <div className="img">
                                <img
                          ...
                          <Accordion.Body>
                            ...
                            <div className="mt-5 From-Control flex justify-center items-center gap-2">
                              <input
                                value={message}
                                type="text "
                                className="p-2"
